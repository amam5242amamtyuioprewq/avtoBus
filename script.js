...
function getTicketNumber(params) {
    ...
    console.log("❌ Номер билета не найден, генерируем новый");
    return "1 000 000 000"; // Default starting number
}
...
function initApp() {
    ...
    const forceTicketNumber = urlParams.force_ticket_number === "true";
    console.log("Auto generate disabled:", autoGenerateDisabled);
    console.log("Force ticket number:", forceTicketNumber);
